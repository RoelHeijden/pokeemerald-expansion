...
#define VAR_ESCAPE_ROOM_MAPSCRIPT_WARP_COUNTER           0x40F8
#define VAR_ESCAPE_ROOM_MAPSCRIPT_RETRIEVE_BALL          0x40F9
#define VAR_ESCAPE_ROOM_MAPSCRIPT_RETRIEVE_PECHA         0x40FA
#define VAR_ESCAPE_ROOM_MAPSCRIPT_HEAL_IF_ALL_FAINTED    0x40FB  
#define VAR_HINTS_USED_COUNTER                           0x40FC
