...
#define HEAL_LOCATION_ESCAPE_ROOM_NURSE1 23
#define HEAL_LOCATION_ESCAPE_ROOM_NURSE2 24
#define HEAL_LOCATION_ESCAPE_ROOM_NURSE3 25
#define HEAL_LOCATION_ESCAPE_ROOM_FINAL_BATTLE 26
