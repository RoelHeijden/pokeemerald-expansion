...
#define POKEBLOCKS_COUNT 2
#define OBJECT_EVENTS_COUNT 38
#define MAIL_COUNT (10 + PARTY_SIZE)
#define SECRET_BASES_COUNT 2
#define POKE_NEWS_COUNT 2
#define PC_ITEMS_COUNT 10
#define BAG_ITEMS_COUNT 10
#define BAG_KEYITEMS_COUNT 4
#define BAG_POKEBALLS_COUNT 4

#define BAG_TMHM_COUNT 67  // CHANGED
