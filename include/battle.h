...
struct BattleStruct
{
    ...
    u8 usedMicleBerry;
    // ADDED
    u8 echoedVoiceChainCount;
    bool8 echoedVoiceUsedThisTurn;
...
extern u8 gPlayerMovesChosen;
extern u16 gBattlerPartyIndexes[MAX_BATTLERS_COUNT];
extern u8 gBattlerPositions[MAX_BATTLERS_COUNT];
extern u8 gActionsByTurnOrder[MAX_BATTLERS_COUNT];
extern u8 gBattlerByTurnOrder[MAX_BATTLERS_COUNT];
extern u8 gBattlerBySpeedOrder[MAX_BATTLERS_COUNT];  // ADDED THIS
...
extern u8 gProtectSuccessLastTurn[MAX_BATTLERS_COUNT];  // ADDED THIS
