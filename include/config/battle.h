...
#define B_RETURN_STOLEN_NPC_ITEMS   FALSE // In Gen5+, Thief and Covet no longer steal items from NPCs.
...
#define B_FLAG_NO_BAG_USE           FLAG_TOGGLE_BAG_USE     // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_OVERWORLD_FOG                 GEN_5      // In Gen8+, overworld Fog summons Misty Terrain in battle. In Gen4 only, overworld Fog summons the unique fog weather condition in battle.
