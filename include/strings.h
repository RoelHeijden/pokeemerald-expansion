...
extern const u8 gText_Birch_ImportantInfo_part1[];
extern const u8 gText_Birch_ImportantInfo_part2[];
...
extern const u8 gText_cannotLearnHM[];
...
extern const u8 gText_DexSearchColorEgg[]; // ADDED
extern const u8 gText_DexSearchColorSkip[]; // ADDED
extern const u8 gText_DexSearchColorDouble[]; // ADDED
extern const u8 gText_DexSearchColorBlank[]; // ADDED
...
extern const u8 gText_HallOfFameDebut1[];
extern const u8 gText_HallOfFameDebut2[];
