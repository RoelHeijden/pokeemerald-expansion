...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ESCAPE_ROOM_MAIN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ESCAPE_ROOM_INDOOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ESCAPE_ROOM_ICE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_ESCAPE_ROOM_OUTDOOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ESCAPE_ROOM_ROCK_PUZZLE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
