...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(BIRD_KEEPER, "Bird Keeper", 8, ITEM_MOON_BALL), // ADDED moon ball
    TRAINER_CLASS(COLLECTOR, "Collector", 15), // REMOVED premier ball
    ...
    TRAINER_CLASS(TUBER_M, "The", 1),
    TRAINER_CLASS(LADY, "LADY", 50),
    TRAINER_CLASS(BEAUTY, "BEAUTY", 20),
    TRAINER_CLASS(RICH_BOY, "Rich Boy", 50, ITEM_MASTER_BALL), // ADDED master ball
    ...
    TRAINER_CLASS(PSYCHIC, "Psychic", 6, ITEM_FAST_BALL), // ADDED fast ball
    ...
    TRAINER_CLASS(CHAMPION, "Champion", 50, ITEM_MASTER_BALL), // added master ball
    ...
    TRAINER_CLASS(TWINS, "Twins", 3, ITEM_TIMER_BALL), // ADDED timer ball
...
//      TRAINER_CLASS(PYRAMID_KING, "PYRAMID KING"),
    TRAINER_CLASS(PYRAMID_KING, "Boomer"), // CHANGED
            ...
            *(gBattleStruct->monToSwitchIntoId + battler) = PARTY_SIZE;
                ...
                || gBattleCommunication[GetBattlerAtPosition(BATTLE_PARTNER(position))] == STATE_WAIT_ACTION_CONFIRMED)
            {
                ...
                else
                {
                    ...
                    else if ((WILD_DOUBLE_BATTLE || (gBattleTypeFlags && BATTLE_TYPE_DOUBLE))
        ...
        case STATE_WAIT_ACTION_CHOSEN: // Try to perform an action.  e.g. run/fight/pokemon/bag
            ...
            if (!(gBattleControllerExecFlags & ((gBitTable[battler]) | (0xF << 28) | (gBitTable[battler] << 4) | (gBitTable[battler] << 8) | (gBitTable[battler] << 12))))
            {
                ...
                case B_ACTION_USE_ITEM:
                    ...
                    // CHANGED - only disable bag for player
                    // if (FlagGet(B_FLAG_NO_BAG_USE))
                    if (FlagGet(B_FLAG_NO_BAG_USE) && GetBattlerSide(battler) == B_SIDE_PLAYER)
                    {
