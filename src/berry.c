...
const struct Berry gBerries[] =
{
    ...
    [ITEM_PECHA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 40,
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(1, 1, 4, 4),  // changed from 2 -> 1
    ...
    [ITEM_RAWST_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 32,
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(1, 1, 4, 4),  // CHANGED 2 -> 1
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(10, 10, 20, 27),
    ...
    [ITEM_MARANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Its outside is very bitter but its"),
        .description2 = COMPOUND_STRING("inside tastes just like cut grass."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 10,
        .dry = 10,
        .sweet = 30,
