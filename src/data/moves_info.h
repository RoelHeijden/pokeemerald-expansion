...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_MIMIC] =
    {
        ...
        .encoreBanned = TRUE,
        .assistBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_SLEEP_TALK_HINT,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_THIEF] =
    {
        ...
        .contestEffect = CONTEST_EFFECT_SLEEP_TALK_HINT2,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_DESTINY_BOND] =
    {
        ...
        .copycatBanned = TRUE,
        .assistBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES2, // changed
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_SKILL_SWAP] =
    {
        ...
        .zMove = { .effect = Z_EFFECT_SPD_UP_1 },
        .ignoresSubstitute = TRUE,
        .contestEffect = CONTEST_EFFECT_SKILL_SWAP_HINT,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_TOXIC_SPIKES] =
    {
        ...
        .skyBattleBanned = TRUE,
        // .contestEffect = CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS,
        .contestEffect = CONTEST_EFFECT_TOXIC_ORB_HINT,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_GRASSY_TERRAIN] =
    {
        ...
        .mirrorMoveBanned = TRUE,
        .skyBattleBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_GRASSY_TERRAIN_HINT,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_RAGE_FIST] =
    {
        ...
        .punchingMove = TRUE,
        .metronomeBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING2, // added
        .contestCategory = CONTEST_CATEGORY_TOUGH, // added
        .contestComboStarterId = 0, // added
        .contestComboMoves = {0}, // added
