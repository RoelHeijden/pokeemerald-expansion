...
static const struct CreditsEntry sCreditsEntry_Creator             = { 69, TRUE,  sCreditsText_Creator };
static const struct CreditsEntry sCreditsEntry_Pokeemerald          = { 69, TRUE,  sCreditsText_Pokeemerald };
static const struct CreditsEntry sCreditsEntry_Tilesets             = { 69, TRUE,  sCreditsText_Tilesets };
static const struct CreditsEntry sCreditsEntry_BattleBackgrounds    = { 69, TRUE,  sCreditsText_BattleBackgrounds };
static const struct CreditsEntry sCreditsEntry_TitleScreen          = { 69, TRUE,  sCreditsText_TitleScreen };
static const struct CreditsEntry sCreditsEntry_ToolsUsed            = { 69, TRUE,  sCreditsText_ToolsUsed };
static const struct CreditsEntry sCreditsEntry_SpecialThanks2        = { 69, TRUE,  sCreditsText_SpecialThanks2 };

static const struct CreditsEntry sCreditsEntry_ByKetch              = { 69, TRUE, sCreditsText_ByKetch };
static const struct CreditsEntry sCreditsEntry_Ketch                = { 69, FALSE, sCreditsText_Ketch };
static const struct CreditsEntry sCreditsEntry_Pret                 = { 69, FALSE, sCreditsText_Pret };
static const struct CreditsEntry sCreditsEntry_RH_Hideout           = { 69, FALSE, sCreditsText_RH_Hideout };
static const struct CreditsEntry sCreditsEntry_Tilesets1             = { 69, FALSE,  sCreditsText_Tilesets1 };
static const struct CreditsEntry sCreditsEntry_Tilesets2             = { 69, FALSE,  sCreditsText_Tilesets2 };
static const struct CreditsEntry sCreditsEntry_Poryscript           = { 69, FALSE, sCreditsText_Poryscript };
static const struct CreditsEntry sCreditsEntry_Porymap              = { 69, FALSE, sCreditsText_Porymap };
static const struct CreditsEntry sCreditsEntry_GraphicsGale          = { 69, FALSE, sCreditsText_GraphicsGale };
static const struct CreditsEntry sCreditsEntry_TilemapStudio         = { 69, FALSE, sCreditsText_TilemapStudio };
static const struct CreditsEntry sCreditsEntry_Accidental            = { 69, FALSE, sCreditsText_Accidental };
static const struct CreditsEntry sCreditsEntry_Datoneman             = { 69, FALSE, sCreditsText_Datoneman };
static const struct CreditsEntry sCreditsEntry_TBD                  = { 69, FALSE, sCreditsText_TBD };
...
static const struct CreditsEntry *const sCreditsEntryPointerTable[PAGE_COUNT][ENTRIES_PER_PAGE] =
{
    ...
    [POKEEMERALD] = {
        _,
        &sCreditsEntry_Pokeemerald,
        &sCreditsEntry_Pret,
        &sCreditsEntry_RH_Hideout,
        _,
    },
    [TILESETS] = {
        _,
        &sCreditsEntry_Tilesets,
        &sCreditsEntry_Tilesets1,
        &sCreditsEntry_Tilesets2,
        _,
    },
    [BATTLE_BACKGROUNDS] = {
        _,
        &sCreditsEntry_BattleBackgrounds,
        &sCreditsEntry_TBD,
        _,
        _,
    },
    ...
    [SPECIAL_THANKS] = {
        ...
        &sCreditsEntry_Datoneman,
        &sCreditsEntry_Accidental,
        _,
    },
    // [PAGE_TITLE] = {
    //     _,
