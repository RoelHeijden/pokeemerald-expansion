static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ESCAPE_ROOM_NURSE - 1] = {MAP_GROUP(ESCAPE_ROOM_MAIN), MAP_NUM(ESCAPE_ROOM_MAIN), 49, 17},
    [HEAL_LOCATION_ESCAPE_ROOM_NURSE2 - 1] = {MAP_GROUP(ESCAPE_ROOM_MAIN), MAP_NUM(ESCAPE_ROOM_MAIN), 21, 12},
};
