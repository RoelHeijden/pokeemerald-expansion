static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ESCAPE_ROOM_NURSE1 - 1] = {MAP_GROUP(ESCAPE_ROOM_MAIN), MAP_NUM(ESCAPE_ROOM_MAIN), 48, 17},
    [HEAL_LOCATION_ESCAPE_ROOM_NURSE2 - 1] = {MAP_GROUP(ESCAPE_ROOM_MAIN), MAP_NUM(ESCAPE_ROOM_MAIN), 20, 11},
    [HEAL_LOCATION_ESCAPE_ROOM_NURSE3 - 1] = {MAP_GROUP(ESCAPE_ROOM_HIDDEN_DUNGEON), MAP_NUM(ESCAPE_ROOM_HIDDEN_DUNGEON), 10, 8},
    [HEAL_LOCATION_ESCAPE_ROOM_FINAL_BATTLE - 1] = {MAP_GROUP(ESCAPE_ROOM_HIDDEN_DUNGEON), MAP_NUM(ESCAPE_ROOM_HIDDEN_DUNGEON), 60, 22},
};
