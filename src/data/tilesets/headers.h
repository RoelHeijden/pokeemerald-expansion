...
const struct Tileset gTileset_JungleRuins =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_JungleRuins,
    .palettes = gTilesetPalettes_JungleRuins,
    .metatiles = gMetatiles_JungleRuins,
    .metatileAttributes = gMetatileAttributes_JungleRuins,
    .callback = NULL,
};
