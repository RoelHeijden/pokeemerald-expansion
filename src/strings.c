...
const u8 gText_OddEggFoundByCouple[] = _("An odd POKéMON EGG hint\nfound in pokédex color."); // CHANGED
...
const u8 gText_HallOfFameDebut3[] = _("Now you can win.");  // ADDED
