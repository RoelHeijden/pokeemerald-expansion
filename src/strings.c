...
const u8 gText_PkmnCantLearnMoveFixMoves[] = _("Restore {STR_VAR_1}'s deleted moves before\nteaching a new one.{PAUSE_UNTIL_PRESS}"); // ADDED
...
const u8 gText_HallOfFameDebut3[] = _("You can beat them.");  // ADDED
