...
const u8 gText_PkmnCantLearnMoveSoftlock[] = _("Teaching {STR_VAR_2} to {STR_VAR_1} would cause a\nsoftlock at a later stage of the game.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd POKéMON EGG found\nby the no double battle."); // CHANGED
