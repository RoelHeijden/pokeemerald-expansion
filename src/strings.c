...
const u8 gText_DefaultNameStu[] = _("Ketch"); // CHANGED
...
const u8 gText_DefaultNameMonica[] = _("Ketch"); // CHANGED
...
const u8 gText_SizeComparedTo[] = _("Size compared to "); // CHANGED
const u8 gText_SizeComparedTo2[] = _("Max Revive... Waste of a turn."); // ADDED
...
const u8 gText_cannotLearnHM[] = _("This HM works without teaching it to a\nPokémon.{PAUSE_UNTIL_PRESS}"); // ADDED
...
const u8 gText_PkmnCantLearnMoveSoftlock[] = _("Teaching {STR_VAR_2} to {STR_VAR_1} would result\nin a softlock much later in the game.{PAUSE_UNTIL_PRESS}"); // ADDED
const u8 gText_PkmnCantLearnMoveFixMoves[] = _("Restore {STR_VAR_1}'s deleted moves\nbefore teaching a new one.{PAUSE_UNTIL_PRESS}"); // ADDED
...
const u8 gText_WouldSoftlock[] = _("SOFTLOCK"); // ADDED
const u8 gText_FixMovesFirst[] = _("FIX MOVES"); // ADDED
const u8 gText_ForgetMoveCustom[] = _("{STR_VAR_1}'s {STR_VAR_2} was removed!"); // ADDED
const u8 gText_MonHas1MoveLeft[] = _("{STR_VAR_1} only has one move left."); // ADDED
...
// const u8 gText_Appeal[] = _("T1: S.");  // CHANGED
// const u8 gText_Jam[] = _(" ");  // CHANGED
...
// const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nmet at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");  // CHANGED
const u8 gText_XNatureMetAtYZ_Hint[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nmet at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}aaaaaaaa{DYNAMIC 1}."); // ADDED
...
// const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nhatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}."); // CHANGED
...
const u8 gText_LowerCaseCancel[] = _("Cancel"); 
...
const u8 gText_MoveRelearnerPkmnLearnedMove[] = _("{STR_VAR_1} learned {STR_VAR_2}!"); // CHANGED
...
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} learned {STR_VAR_2}!"); // CHANGED
...
const u8 gText_UndoUsedItems[] = _("Undo item use");
const u8 gText_UndoOtherAction[] = _("Undo other");
const u8 gText_DeleteMove[] = _("Delete a move");
const u8 gText_RestoreMove[] = _("Restore deleted moves");
