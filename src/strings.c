...
const u8 gText_DefaultNameStu[] = _("PLAYER");
...
const u8 gText_cannotLearnHM[] = _("This HM cannot be taught to Pokémon.\nHaving it in your bag is sufficient.{PAUSE_UNTIL_PRESS}"); // ADDED
const u8 gText_cannotLearnHM[] = _("This HM does not have to be taught to\na Pokémon. Just having the HM in\lyour bag will suffice.{PAUSE_UNTIL_PRESS}"); // ADDED
...
const u8 gText_HallOfFameDebut[] = _("Smeargle knows another move.");  // CHANGED
